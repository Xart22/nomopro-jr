...
class ConnectionModal extends React.Component {
    constructor(props) {
        ...
        this.state = {
            device: this.props.deviceData.find(
    ...
    render() {
        return (
            <ConnectionModalComponent
                connectingMessage={
                    this.state.device && this.state.device.connectingMessage
                }
                connectionIconURL={
                    this.state.device && this.state.device.connectionIconURL
                }
                connectionSmallIconURL={
                    this.state.device &&
                    this.state.device.connectionSmallIconURL
                }
                ...
                connectionTipIconURL={
                    this.state.device && this.state.device.connectionTipIconURL
                }
